...
# ==========================================================================================================================================  
        ...
        page1.wait_for_timeout(1000)
        page1.locator("#selDis-filterInput").fill("AMAADVICE - 07 - AMA (Left Against Medical Advice)")
        page1.get_by_text("AMAADVICE - 07 - AMA (Left Against Medical Advice)").click()
        logger.info("Discharge Disposition Updated to AMAADVICE - 07 - AMA (Left Against Medical Advice)")
        end_step()
# ==========================================================================================================================================
# Place on Hold
# ==========================================================================================================================================
