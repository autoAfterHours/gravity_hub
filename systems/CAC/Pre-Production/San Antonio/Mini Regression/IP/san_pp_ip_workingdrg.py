...
def run(playwright: Playwright) -> None:
    ...
    crs_frame = None
    try:
        pre_run_check("https://FWDCWTWEBCAC01B.HCA.CORPAD.NET/3M_360App")
...
# ===========================================================================
        ...
        step("San Antonio Pre-Production CAC Dashboard", 
        "Launching Browser & Navigating to Dashboard")
        
        page.goto("https://FWDCWTWEBCAC01B.HCA.CORPAD.NET/3M_360App")
