...
# ==========================================================================================================================================
    ...
    try:
        pre_run_check("https://FWDCWTWEBCAC02B.HCA.CORPAD.NET/3M_360App")
...
# ==========================================================================================================================================
        ...
        step("Dallas Pre-Production CAC Dashboard", "Launching Browser & Navigating to Dashboard")

        page.goto("https://FWDCWTWEBCAC02B.HCA.CORPAD.NET/3M_360App", wait_until="domcontentloaded")
...
# ==========================================================================================================================================  
        ...
        page.get_by_role("textbox", name="Type visit ID or patient name").fill("COCCRBH0000018562")
        page.wait_for_timeout(1000)
        
        try:
            with page.expect_popup() as page1_info:
                patient_record = page.get_by_role("row", name="Visit ID: COCCRBH0000018562").locator("#visitid")
                if patient_record.is_visible():
                    safe_click(patient_record, "Patient Visit")
                    page1 = page1_info.value
                else:
                    raise Exception()
        except:
                manual_prompt(
                message="Unable to find Patient. Please Open Another Patient Record or Hit Stop Job to End Run",
...
# ==========================================================================================================================================
        ...
        manual_prompt(
            message="Confirm Patient Account Loaded",
            completion_note="Patient Loaded Successfully"
        )
        screenshot(page1, "confirm_documentsandcodes")
