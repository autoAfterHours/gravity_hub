...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwpappcac07b.hca.corpad.net/launchCRS.html")
    ...
    # Navigate to Codefinder Page
        ...
        page.goto("https://xrdcwpappcac07b.hca.corpad.net/launchCRS.html", wait_until="domcontentloaded")
