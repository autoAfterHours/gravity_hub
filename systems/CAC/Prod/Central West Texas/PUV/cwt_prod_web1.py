...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://fwdcwpappcac22b.hca.corpad.net/winapplink?url360=https://cwt360.hca.corpad.net/3M_360App")
    ...
    # Navigate to WinAppLink Page
        ...
        page.goto("https://fwdcwpappcac22b.hca.corpad.net/winapplink?url360=https://cwt360.hca.corpad.net/3M_360App", wait_until="domcontentloaded")
