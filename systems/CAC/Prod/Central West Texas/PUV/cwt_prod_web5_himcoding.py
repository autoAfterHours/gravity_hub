...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://FWDCWPWEBCAC22B.HCA.CORPAD.NET/3M_360App")
    ...
    # Navigate to CAC Dashboard Loaded
        ...
        page.goto("https://FWDCWPWEBCAC22B.HCA.CORPAD.NET/3M_360App", wait_until="domcontentloaded")
    ...
    # Navigate to HIM Coding Dashboard
        ...
        # CLI Worklist
        step("CLI", "Navigating to CLI Worklist")
        page.get_by_text("CLI", exact=True).click()
        page.wait_for_timeout(4000)
        page.wait_for_load_state("domcontentloaded")
        screenshot(page, "him_coding_cli_wl_loaded")
        logger.info("CLI")
        end_step()
