...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwpappcac21b.hca.corpad.net/launchCRS.html")
    ...
    # Navigate to Codefinder Page
        ...
        page.goto("https://xrdcwpappcac21b.hca.corpad.net/launchCRS.html", wait_until="domcontentloaded")
