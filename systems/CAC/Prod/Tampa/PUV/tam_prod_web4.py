...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://tam360.hca.corpad.net/sts/VersionInformation.aspx")
    ...
    # Navigate to STS Version Info Page
        ...
        page.goto("https://tam360.hca.corpad.net/sts/VersionInformation.aspx", wait_until="domcontentloaded")
