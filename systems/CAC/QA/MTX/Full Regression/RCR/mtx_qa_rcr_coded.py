...
# ==========================================================================================================================================
        ...
        end_step()
# Navigate to HIM Coding Dashboard > RCR Ready Worklist
        page.wait_for_timeout(2000)
        page.get_by_text("HIM Coding").click()
        page.wait_for_timeout(2000)
        page.get_by_text("RCR", exact=True).click()
        page.wait_for_timeout(2000)
...
## Code Patient (Outpatient Recurring Wound Care)
# Add Admit DX Code (L89324)
...
# Complete & Confirm Results (2nd Try)
        page1.wait_for_timeout(2000)
        page1.locator("#crsOuterIframe").content_frame.get_by_text("</body> </html>").content_frame.get_by_role("button", name="Complete").click()

# Submit Account (Coded)
        page1.wait_for_timeout(2000)
