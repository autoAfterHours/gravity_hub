...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwqappcac20b.hcaqa.corpadqa.net/winapplink?url360=https://xrdcwqwebcac20b.hcaqa.corpadqa.net/3M_360App")
    ...
    # Navigate to WinAppLink Page
        ...
        page.goto("https://xrdcwqappcac20b.hcaqa.corpadqa.net/winapplink?url360=https://xrdcwqwebcac20b.hcaqa.corpadqa.net/3M_360App", wait_until="domcontentloaded")
