...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwqwebcac20b.hcaqa.corpadqa.net/sts/VersionInformation.aspx")
    ...
    # Navigate to STS Version Info Page
        ...
        page.goto("https://xrdcwqwebcac20b.hcaqa.corpadqa.net/sts/VersionInformation.aspx", wait_until="domcontentloaded")
