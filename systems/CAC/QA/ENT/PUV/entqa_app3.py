...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwqappcac08b.hcaqa.corpadqa.net/launchCRS.html")
    ...
    # Navigate to Codefinder Page
        ...
        page.goto("https://xrdcwqappcac08b.hcaqa.corpadqa.net/launchCRS.html", wait_until="domcontentloaded")
