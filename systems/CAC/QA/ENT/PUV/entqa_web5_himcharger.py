...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwqwebcac08b.hcaqa.corpadqa.net/3M_360App/dashboard")
    ...
    # Navigate to CAC Dashboard
        ...
        page.goto("https://xrdcwqwebcac08b.hcaqa.corpadqa.net/3M_360App/dashboard", wait_until="domcontentloaded")
