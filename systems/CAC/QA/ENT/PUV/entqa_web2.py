...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwqwebcac08b.hcaqa.corpadqa.net/WebCvConfig/")
    ...
    # Navigate to WebCvConfig
        ...
        page.goto("https://xrdcwqwebcac08b.hcaqa.corpadqa.net/WebCvConfig/", wait_until="domcontentloaded")
