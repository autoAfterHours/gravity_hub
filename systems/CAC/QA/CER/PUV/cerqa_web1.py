...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwqappcac10b.hcaqa.corpadqa.net/winapplink?url360=https://xrdcwqwebcac10b.hcaqa.corpadqa.net/3M_360App")
    ...
    # Navigate to WinAppLink Page
        ...
        page.goto("https://xrdcwqappcac10b.hcaqa.corpadqa.net/winapplink?url360=https://xrdcwqwebcac10b.hcaqa.corpadqa.net/3M_360App", wait_until="domcontentloaded")
