...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://fwdcwtappcac01b.hcaqa.corpadqa.net/CRSConfigPlatform.html")
    ...
    # Navigate to CRS Config Utility Page
        ...
        page.goto("https://fwdcwtappcac01b.hcaqa.corpadqa.net/CRSConfigPlatform.html", wait_until="domcontentloaded")
