...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://fwdcwtappcac01b.hca.corpad.net/launchCRS.html")
    ...
    # Navigate to Codefinder Page
        ...
        page.goto("https://fwdcwtappcac01b.hca.corpad.net/launchCRS.html", wait_until="domcontentloaded")
