...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwtappcac23b.hca.corpad.net/winapplink?url360=https://xrdcwtwebcac23b.hca.corpad.net/3M_360App")
    ...
    # Navigate to WinAppLink Page
        ...
        page.goto("https://xrdcwtappcac23b.hca.corpad.net/winapplink?url360=https://xrdcwtwebcac23b.hca.corpad.net/3M_360App", wait_until="domcontentloaded")
