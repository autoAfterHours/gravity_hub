...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwtappcac10b.hca.corpad.net/winapplink?url360=https://xrdcwtwebcac10b.hca.corpad.net/3M_360App")
    ...
    # Navigate to WinAppLink Page
        ...
        page.goto("https://xrdcwtappcac10b.hca.corpad.net/winapplink?url360=https://xrdcwtwebcac10b.hca.corpad.net/3M_360App", wait_until="domcontentloaded")
