...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://fwdcwtappcac03b.hca.corpad.net/CRSConfigPlatform.html")
    ...
    # Navigate to CRS Config Utility Page
        ...
        page.goto("https://fwdcwtappcac03b.hca.corpad.net/CRSConfigPlatform.html", wait_until="domcontentloaded")
