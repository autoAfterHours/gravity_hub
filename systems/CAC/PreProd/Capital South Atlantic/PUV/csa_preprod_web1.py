...
def run(playwright: Playwright) -> None:
    ...
    page    = None
    try:
        pre_run_check("https://xrdcwtappcac20b.hca.corpad.net/winapplink?url360=https://xrdcwtwebcac20b.hca.corpad.net/3M_360App")
    ...
    # Navigate to WinAppLink Page
        section_break("WinAppLink")
        step("WinAppLink", "Launching WinAppLink")
        page.goto("https://xrdcwtappcac20b.hca.corpad.net/winapplink?url360=https://xrdcwtwebcac20b.hca.corpad.net/3M_360App", wait_until="domcontentloaded")
        page.wait_for_timeout(4000)
        screenshot(page, "winapplink_loaded")
        logger.info("WinAppLink Successfully Loaded")
        end_step()
